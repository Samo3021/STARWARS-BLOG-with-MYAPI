...
export const Register = () => {
	...
	const handleSubmit = e => {
		...
		fetch("https://3000-crimson-baboon-3drybsqc.ws-us03.gitpod.io/register", {
			method: "POST",
			headers: {
	...
	return (
		<div className="text-center mt-5 d-flex justify-content-center align-items-center  m-5 p-4 mb-5 w-5">
